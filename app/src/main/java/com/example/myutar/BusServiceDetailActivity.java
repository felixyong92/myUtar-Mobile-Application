...
public class BusServiceDetailActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (getIntent().getStringArrayExtra("attachment") == null) {
            ...
            for (int i = 0; i < attachments.length; i++) {
                ...
                final String attachmentUrl = "https://myutar.000webhostapp.com/MyUTAR/basic/web/uploads/attachments/" + attachments[i].toString();
